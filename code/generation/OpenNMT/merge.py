...
def read_template(path, entity1, entity2):
    sr = codecs.open(path, "r", "utf-8")
    sw = codecs.open("/home/dell/zjx/MSParS_V2.0_single_2_newme/code/generation/OpenNMT/final_output_single.txt", 'w', 'utf-8')
    lines = sr.readlines()
    final_answer = []
...
def mer():
    entity1 = read_entity("/home/dell/zjx/MSParS_V2.0_single_2_newme/code/generation/OpenNMT/pred_entity1.txt")
    entity2 = read_entity("/home/dell/zjx/MSParS_V2.0_single_2_newme/code/generation/OpenNMT/pred_entity2.txt")
    read_template("/home/dell/zjx/MSParS_V2.0_single_2_newme/code/generation/OpenNMT/output.txt", entity1, entity2)
    #read_template("multi-without-copy.txt", entity1, entity2)
    with open('/home/dell/zjx/MSParS_V2.0_single_2_newme/code/generation/OpenNMT/final_output_single.txt', 'r', encoding='utf-8') as f:
