...
from onmt.modules.multi_headed_attn_trans import MultiHeadedAttentionTrans
...
__all__ = ["Elementwise", "context_gate_factory", "ContextGate",
           ...
           "PositionalEncoding", "WeightNormConv2d", "AverageAttention", "MultiHeadedAttentionTrans"]
