...
def translate_opts(parser):
    ...
    group.add_argument('-model', dest='models', metavar='MODEL',
                       nargs='+', type=str, default=['/home/dell/zjx/MSParS_V2.0_single_2_newme/code/generation/OpenNMT/available_models/demo-single-model-transformer12_step_40000.pt'], required=False,
    ...
    group.add_argument('-src', required=False,default="data.txt",
                       help="""Source sequence to decode (one line per
                       sequence)""")
    group.add_argument('-src_dir', default="",
                       help='Source directory for image or audio files')
    group.add_argument('-tgt',default="tgt.txt",
                       help='True target sequence (optional)')
    group.add_argument('-output', default='output.txt',
    ...
    group.add_argument('-replace_unk', default=True,
    ...
    group = parser.add_argument_group('Logging')
    group.add_argument('-verbose', default=True,
