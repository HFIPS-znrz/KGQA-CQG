...
def translate_opts(parser):
    ...
    group.add_argument('-model', dest='models', metavar='MODEL',
                       nargs='+', type=str, default=['/home/dell/zjx/MSParS_V2.0_single_2_newme/code/generation/OpenNMT/available_models/demo-single-model-transformer11_step_40000.pt'], required=False,
