...
class RelationExtractor(nn.Module):
    ...
    entdrop=0.0, reldrop=0.0, scoredrop=0.0, l3_reg=0.0, model='ComplEx', ls=0.0, do_batch_norm=True, freeze=True):
        ...
        self.roberta_model = BertModel.from_pretrained('/home/dell/zjx/EmbedKGQA/roberta/chinese-roberta-wwm-ext-large')
    ...
    def ComplEx(self, head, relation):
        ...
        # print('re', re_head.size())
        # print('rel', re_relation.size())

        a = re_head * re_relation
