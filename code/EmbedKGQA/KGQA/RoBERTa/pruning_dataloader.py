...
class DatasetPruning(Dataset):
    def __init__(self, data, rel2idx, idx2rel):
        ...
        self.pretrained_weights = 'chinese-roberta-wwm-ext'
        # self.tokenizer = self.tokenizer_class.from_pretrained(self.pretrained_weights, cache_dir='.')
        self.tokenizer = self.tokenizer_class.from_pretrained('/home/dell/zjx/EmbedKGQA/roberta/chinese-roberta-wwm-ext-large')
