...
def prepare_embeddings(embedding_dict):
    ...
    i = 0
    embedding_matrix = []
    # print(embedding_dict)  # 实体名：实体emb
    for key, entity in embedding_dict.items():
        entity2idx[key.strip()] = i
        idx2entity[i] = key.strip()
        i += 1
        embedding_matrix.append(entity)
    print('enti2', len(entity2idx.keys()))
    print('idx2', len(idx2entity.keys()))
        ...
        for phase in phases:
            if phase == 'train':
                ...
                for i_batch, a in enumerate(loader):
                    ...
                    # print('posi_head', positive_head.size())
                    # print('posi_tail', positive_tail.size())                    
                ...
                if score > best_score + eps:
                    ...
                    if freeze == True:
                        suffix = '_frozen'
                    checkpoint_path = '../../checkpoints/corn/'
...
data_path = '../../data/corn/qa_train.txt'
...
valid_data_path = '../../data/corn/qa_dev.txt'
test_data_path = '../../data/corn/qa_test.txt'
...
embedding_folder = '../../kg_embeddings/corn'
...
if args.mode == 'train':
    ...
    entity_dict=entity_dict, 
    relation_dict=relation_dict,
    model_path='../../checkpoints/corn/best_score_model.pt',
